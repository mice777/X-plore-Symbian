...
/*
#ifndef PNG_ABORT
#  define PNG_ABORT() Fatal("PNG Lib")
#endif
*/
...
int png_memcmp(const void *mem1, const void *mem2, dword len);
dword png_strlen(const char *cp);
char *png_strcpy(char *dst, const char *src);
