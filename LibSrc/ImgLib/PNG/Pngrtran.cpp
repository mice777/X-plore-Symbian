 ...
 */
bool /* PRIVATE */png_do_read_transformations(png_structp png_ptr){
   ...
   if (png_ptr->row_buf == NULL)
   {
      ...
      sprintf(msg, "NULL row buffer for row %ld, pass %d", png_ptr->row_number,
         png_ptr->pass);
      return false;//png_error(png_ptr, msg);
#else
      return false;//png_error(png_ptr, "NULL row buffer");
#endif
   }
#endif
   ...
   if (png_ptr->transformations & PNG_RGB_TO_GRAY)
   {
      ...
      if(rgb_error)
      {
         ...
         if(png_ptr->transformations == PNG_RGB_TO_GRAY_ERR)
            return false;//png_error(png_ptr, "png_do_rgb_to_gray found nongray pixel");
      }
   }
#endif
 ...
 */
   ...
   if (png_ptr->transformations & PNG_DITHER)
   {
      ...
      if(png_ptr->row_info.rowbytes == (png_uint_32)0)
         return false;//png_error(png_ptr, "png_do_dither returned rowbytes=0");
   }
#endif
